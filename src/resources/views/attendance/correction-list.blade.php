    ...
    @elseif ($tab === 'approved')
        <div class="panel-listed">
            <table class="table">
                ...
                <tr class="table-row">
                    <td class="data">{{ $attendance->correction->status }}</td>
                    <td class="data">{{ $attendance->user->name }}</td>
                    <td class="data">{{ \Carbon\Carbon::parse($attendance->date)->format('Y/m/d') }}</td>
                    <td class="data">{{ $attendance->correction->remarks }}</td>
                    <td class="data">{{ \Carbon\Carbon::parse($attendance->correction->applied_at)->format('Y/m/d') }}</td>
                    <td class="data">
                        <a href="{{ route('attendance.detail', ['id' => $attendance->id]) }}" class="detail-link">詳細</a>
                    </td>
                </tr>
